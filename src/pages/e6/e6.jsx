...
export default function Exercicio2() {
    ...
    <div className="principal1">
        ...
        <Link to='/'>
            ...
            <h1 className="hz">Exercício 06 - Tabuada</h1>
        </div>
        ...
        <div className="quadrado11">
            <p>Implementar um programa em javascript que escreva no terminal a tabuada de um número informado pelo usuário. A mensagem deve estar no formato: "A x B = X"</p>
        </div>

        <div className="botao11">
            <h6>Número da tabuada</h6>
            ...
            {resultado.map(item => 
            <h3 className="h1">  A tabuada é {item} </h3> 
            )}
